...
void spm_pmic_power_mode(int mode, int force, int lock)
{
	...
	case PMIC_PWR_DEEPIDLE:
		...
		/*add by wuyujing,TP use vldo28 ldo,when system sleep, start*/
#if  !defined(NX573J)
		pmic_ldo_vldo28_hw_lp_mode(4/*VLDO28_LPSEL_SRCLKEN2*/);
#endif
		/*add by wuyujing,TP use vldo28 ldo,when system sleep, end*/
	...
	case PMIC_PWR_SUSPEND:
		...
		/* ldo control */
		/*add by wuyujing,TP use vldo28 when system sleep,start*/
#if !defined(NX573J)
