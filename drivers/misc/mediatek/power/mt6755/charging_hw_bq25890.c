...
#ifdef CONFIG_NUBIA_PM_COMMON_FEATURE
    reg = bq25890_get_vbus_state();
    /*0b001:USB_SDP, 0b010:USB CDP, 0b011:USB DCP, 0b100:HVDCP*/
    if(reg == 0x01) {
        *(CHARGER_TYPE *) (data) = STANDARD_HOST;
...
#endif
#ifdef CONFIG_NUBIA_PM_COMMON_FEATURE
	bq25890_config_interface(bq25890_CON2, 0x1, 0x1, 1);	/* enable DPDM detection */
#else
