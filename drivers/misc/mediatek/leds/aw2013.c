...
error_set_vtg_vcc_ana:
    ...
    hwPowerOn(MT6353_POWER_LDO_VIO28, VOL_2800 * 1000, "VIO28_PMU");
	//printk(KERN_ERR"xiaofeng:after VIO28_PMU! %s\n",__func__);

	hwPowerOn(MT6353_POWER_LDO_VIO18, VOL_1800 * 1000, "VIO18_PMU");
...
static int __init aw2013_init(void)
{
	...
	//i2c_put_adapter;
	msleep(10);
    err = platform_driver_register(&aw2013_platform_driver);
	if(err)
	{
