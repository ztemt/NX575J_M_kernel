...
#define AF_DRVNAME "BU6429AF_MAIN_SZSEASON_DRV"
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	#else
       puSendCmd_data[0] = (char)(((a_u2Data >> 8) & 0x03) | 0xC4);
       puSendCmd_data[1] = (char)(a_u2Data & 0xFF);
       i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd_data, 2);
	#endif
...
static int init_setting2(void)
{
	int  i4RetValue;
	char puSendCmd[2];

	char  resonant_frequency = 175;
	u16 ISRC_value = 1;

       printk("init_setting2!!\n");
	g_pstAF_I2Cclient->timing = 400;	
	g_pstAF_I2Cclient->addr = AF_I2C_SLAVE_ADDR;
	g_pstAF_I2Cclient->addr = g_pstAF_I2Cclient->addr >> 1;
	g_pstAF_I2Cclient->ext_flag |= I2C_A_FILTER_MSG;
	
        puSendCmd[0] = (char)(((resonant_frequency >> 8) & 0x03) | 0xD4);
        puSendCmd[1] = (char)(resonant_frequency & 0xFF);
        i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd, 2);
        if (i4RetValue < 0) {
            LOG_INF("I2C send failed!!\n");
        ...
        puSendCmd[0] = (char)(((ISRC_value >> 8) & 0x03) | 0xCC); 
        puSendCmd[1] = (char)(ISRC_value & 0x07);
        i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd, 2);
        if (i4RetValue < 0) {
            LOG_INF("I2C send failed!!\n");
            return -1;
...
/* ////////////////////////////////////////////////////////////// */
long BU6429AF_MAIN_SZSEASON_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int BU6429AF_MAIN_SZSEASON_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void BU6429AF_MAIN_SZSEASON_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
