...
#define AF_DRVNAME "BU6429AF_MAIN_QTECH_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long BU6429AF_MAIN_QTECH_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int BU6429AF_MAIN_QTECH_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void BU6429AF_MAIN_QTECH_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
