...
#ifdef CONFIG_MTK_LENS_BU6429AF_MAIN_QTECH_SUPPORT
extern void BU6429AF_MAIN_QTECH_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long BU6429AF_MAIN_QTECH_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int BU6429AF_MAIN_QTECH_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_BU6429AF_MAIN_SZSEASON_SUPPORT
extern void BU6429AF_MAIN_SZSEASON_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long BU6429AF_MAIN_SZSEASON_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int BU6429AF_MAIN_SZSEASON_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
