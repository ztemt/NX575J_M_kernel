...
#define MICROARRAY_VENDOR_ID    0x02
#define GOODIX_VENDOR_ID    0xff
...
int get_fp_vendor(void)
{
    ...
    case FPC_VENDOR_ID:
        ...
        printk("It's FPC chip %s:%d->0x%x\n", __func__, __LINE__, fp_vendor);
        break;
    case MICROARRAY_VENDOR_ID:
        fp_vendor = MICROARRAY_VENDOR;
        printk("It's MicroArray chip %s:%d->0x%x\n", __func__, __LINE__, fp_vendor);
        break;
    case GOODIX_VENDOR_ID:
        fp_vendor = GOODIX_VENDOR;
        printk("It's  Goodix chip %s:%d->0x%x\n", __func__, __LINE__, fp_vendor);
        break;
