...
#endif
#if defined(HX8394F_HD_DSI_VDO)
	&hx8394f_hd_dsi_vdo_lcm_drv,
#endif

#if defined(NT35521S_HD720_DSI_VIDEO_CPT)
	&nt35521s_hd720_cpt_lcm_drv,
#endif

#if defined(RM67120_DSI_VDO_HD_GVO)
       &rm67120_dsi_vdo_hd_gvo_drv,
#endif

#if defined(ILI9881C_DSI_HD_VDO_DJ_SP504)
       &ili9881c_dsi_hd_vdo_dj_sp504_drv,
#endif

#if defined(ILI9881C_DSI_HD_VDO_YASSY_CMI)
       &ili9881c_dsi_hd_vdo_yassy_cmi_drv,
#endif
};
